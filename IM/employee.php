...
cursor: pointer;
    ...
    }.menu-items{margin: 100px auto;width: 350px;background-color: #fff;padding: 60px;}
...
<nav>
	 <div class="welcome">
	 	<div class="title">Welcome <b>"John China!"</b>To you auction station</div>
	
     <input type="text" placeholder="Type your Item name here to sell"></input>

     ₱<input type="text" placeholder="Input Price here"></input>
     <button class="signin-btn">Upload and Sell</button>
   </div>
