...
<style>
    *{font-family: 'Oswald', sans-serif;}body { background-color: #212121 ;}.form {margin: 100px auto;width: 350px;background-color: #fff;padding: 60px;}.logo{background-color: #212121;width: 150px;height: 150px;border-radius: 50%;margin: 0 auto;margin-buttom: 10px;}.logo img{width: 100%;}.title, .sub-title {color: #212121;}.title{font-weight: bolder;font-size: 35px;text-align: center;}.sub-title{font-size: 10px;}.form {width: 100%margin-top: 30px;}.form-input {font-size: 10px;padding: 10px 20px 10px 5px;border: none;outline: none;background: none;align-self: center;}.username .password {display: block;border-radius: 30px;border: 1px solid rgb(0, 0, 0, 0, 2);margin: 10px 0;} svg{height: 16px;margin-bottom: -5;margin-left: 10px;margin-right: 5px;}.option{display: flex;flex-direction: row;justify-content: space-between;padding: 5px 0px;margin-bottom: 30px;}Button{width: 100%;padding: 12px 10px;border: none;font-size: 10px;border-radius: 30px;background-color: #720e9e;color: #FFF;margin-bottom: 5px;cursor: pointer; }
</style>
...
<body>
    <div class="form">
        <form>
            ...
            <div class="title">Welcome "Givenkun"</div>
            ...
            <button>
                ...
                </svg>Pending New Registered Employee🟢
                <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <button>
                ...
                </svg>Pending New Registered Customer🟢
                <svg class="svg-icon" viewBox="0 0 20 20">
                    <path fill="none" d="M13.388,9.624h-3.011v-3.01c0-0.208-0.168-0.377-0.376-0.377S9.624,6.405,9.624,6.613v3.01H6.613c-0.208,0-0.376,0.168-0.376,0.376s0.168,0.376,0.376,0.376h3.011v3.01c0,0.208,0.168,0.378,0.376,0.378s0.376-0.17,0.376-0.378v-3.01h3.011c0.207,0,0.377-0.168,0.377-0.376S13.595,9.624,13.388,9.624z M10,1.344c-4.781,0-8.656,3.875-8.656,8.656c0,4.781,3.875,8.656,8.656,8.656c4.781,0,8.656-3.875,8.656-8.656C18.656,5.219,14.781,1.344,10,1.344z M10,17.903c-4.365,0-7.904-3.538-7.904-7.903S5.635,2.096,10,2.096S17.903,5.635,17.903,10S14.365,17.903,10,17.903z"></path>
                </svg>
            </button>
            <button>
                ...
                </svg>Pending New Added Items</button>
            ...
            <button>
                ...
                </svg>Delete Employee🔴</button>

            <button>
                <svg class="svg-icon" viewBox="0 0 20 20">
                    <path d="M17.114,3.923h-4.589V2.427c0-0.252-0.207-0.459-0.46-0.459H7.935c-0.252,0-0.459,0.207-0.459,0.459v1.496h-4.59c-0.252,0-0.459,0.205-0.459,0.459c0,0.252,0.207,0.459,0.459,0.459h1.51v12.732c0,0.252,0.207,0.459,0.459,0.459h10.29c0.254,0,0.459-0.207,0.459-0.459V4.841h1.511c0.252,0,0.459-0.207,0.459-0.459C17.573,4.127,17.366,3.923,17.114,3.923M8.394,2.886h3.214v0.918H8.394V2.886z M14.686,17.114H5.314V4.841h9.372V17.114z M12.525,7.306v7.344c0,0.252-0.207,0.459-0.46,0.459s-0.458-0.207-0.458-0.459V7.306c0-0.254,0.205-0.459,0.458-0.459S12.525,7.051,12.525,7.306M8.394,7.306v7.344c0,0.252-0.207,0.459-0.459,0.459s-0.459-0.207-0.459-0.459V7.306c0-0.254,0.207-0.459,0.459-0.459S8.394,7.051,8.394,7.306"></path>
                </svg>Delete Customer🔴
                <input type="text" Value="Xmen"></button>
        </form>
    </div>
</body>

</html>\\Coded by Given-kun